...
"""Memory stress problem in the HotelReservation application."""
...
################## Detection Problem ##################
class MemoryStressDetection(MemoryStressBaseTask, DetectionTask):
    def __init__(self):
        MemoryStressBaseTask.__init__(self)
...
class MemoryStressLocalization(
    MemoryStressBaseTask, LocalizationTask
):
    def __init__(self):
        MemoryStressBaseTask.__init__(self)
