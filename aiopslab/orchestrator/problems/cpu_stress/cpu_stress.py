...
################## Detection Problem ##################
class CPUStressDetection(CPUStressBaseTask, DetectionTask):
    def __init__(self):
        CPUStressBaseTask.__init__(self)
...
class CPUStressLocalization(
    CPUStressBaseTask, LocalizationTask
):
    def __init__(self):
        CPUStressBaseTask.__init__(self)
